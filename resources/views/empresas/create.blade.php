...
<x-app-layout>
  <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
      ...
      <form method="post" enctype="multipart/form-data" action="{{route('empresas.store')}}">
        @csrf
        <div class="form-group">
          <x-input-label for="nomeEmpresa">Nome da Empresa</x-input-label>
          <x-text-input type="text" class="form-control" id="nomeEmpresa" name="nomeEmpresa" placeholder="Nome do Empresa" />
          ...
          <x-text-input type="text" class="form-control" id="enderecoEmpresa" name="enderecoEmpresa" placeholder="Endereço do Empresa" />
          ...
          <x-text-input id="telefoneEmpresa" class="form-control" type="text" name="telefoneEmpresa" :value="old('telefoneEmpresa')" required autocomplete="telefoneEmpresa" placeholder="(99) 99999-9999" pattern="\(\d{2}\) \d{5}-\d{4}" maxlength="15" oninput="this.value = this.value.replace(/\D/g, '').replace(/(\d{2})(\d{5})(\d{4})/, '($1) $2-$3')" />
          ...
          <x-text-input type="email" class="form-control" id="emailEmpresa" name="emailEmpresa" placeholder="Email do Empresa" />
          ...
          <textarea id="descricaoEmpresa" class="block mt-1 w-full" type="text" name="descricaoEmpresa" :value="old('descricaoEmpresa')" required autocomplete="descricaoEmpresa"></textarea>
          ...
          <label class="switch">
            ...
            <input type="checkbox" name="statusEmpresa" id="statusEmpresa" value="1">
