  ...
  <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">  
    ...
    <form method="post" enctype="multipart/form-data" action="{{route('empresas.update', $empresa)}}">
        ...
        <div class="form-group">
            ...
            value="{{$empresa->telefoneEmpresa}}" required autocomplete="telefoneEmpresa" 
        ...
        <textarea id="descricaoEmpresa" class="block mt-1 w-full" type="text" name="descricaoEmpresa" required autocomplete="descricaoEmpresa">{{$empresa->descricaoEmpresa}}</textarea>
